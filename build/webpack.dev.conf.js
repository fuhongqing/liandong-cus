...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    historyApiFallback: {
      rewrites: [
        {from: /index/, to: config.dev.assetsPublicPath + 'src/pages/index/index.html'},
        {from: /yeji/, to: config.dev.assetsPublicPath + 'src/pages/yeji/yeji.html'},
        {from: /customer/, to: config.dev.assetsPublicPath + 'src/pages/customer/customer.html'},
      ],
    },
    hot: true,
